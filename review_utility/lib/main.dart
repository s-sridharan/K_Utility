...
// // // import 'dart:convert';
// // // import 'dart:io';
// // // import 'package:syncfusion_flutter_charts/charts.dart'; // Importing the chart library
// // //
// // // void main() {
// // //   runApp(MyApp());
// // // }
...
// // //                     children: [
// // //                       if (_isLoading)
// // //                         Text(_progressLog, style: TextStyle(fontSize: 14, color: MyApp.navyBlue)),
// // //                       _buildInstructionText(
// // //                           'Google Play Store: Enter the URL of the app page from the Google Play Store to analyze the reviews.'),
// // //                       _buildTextField(_googleController, 'Enter Google Play Store link'),
// // //                       _buildAnalyzeButton(() => _analyzeSentiment('google', _googleController.text)),
// // //                       _buildResultSection(_googleTotalReviews, _googleSentimentBuckets, _googleMessage),
// // //
// // //                       SizedBox(height: 20),
// // //
// // //                       _buildInstructionText(
...
// // //                       _buildTextField(_appleController, 'Enter Apple App Store link'),
// // //                       _buildAnalyzeButton(() => _analyzeSentiment('apple', _appleController.text)),
// // //                       _buildResultSection(_appleTotalReviews, _appleSentimentBuckets, _appleMessage),
// // //
// // //                       SizedBox(height: 20),
// // //
// // //                       _buildInstructionText(
...
// // //                       _buildTextField(_twitterController, 'Enter Twitter hashtag'),
// // //                       _buildAnalyzeButton(() => _analyzeSentiment('twitter', _twitterController.text)),
// // //                       _buildResultSection(_twitterTotalReviews, _twitterSentimentBuckets, _twitterMessage),
// // //                     ],
// // //                   ),
// // //                 ),
// // //               ),
        ...
        try {
          ...
          setState(() {
            if (type == 'google') {
              _googleTotalReviews = data['totalReviews'] ?? 0;
              _googleSentimentBuckets = Map<String, int>.from(data['sentimentBuckets'] ?? {});
              _googleRatingDistribution = Map<String, int>.from(data['ratingDistribution'] ?? {});

            } else if (type == 'apple') {
              _appleTotalReviews = data['totalReviews'] ?? 0;
              _appleSentimentBuckets = Map<String, int>.from(data['sentimentBuckets'] ?? {});
              _appleRatingDistribution = Map<String, int>.from(data['ratingDistribution'] ?? {});
            } else if (type == 'twitter') {
              _twitterTotalReviews = data['totalReviews'] ?? 0;
              _twitterSentimentBuckets = Map<String, int>.from(data['sentimentBuckets'] ?? {});
            }
          ...
          setState(() {
            if (type == 'google') {
              _googleTotalReviews = 0;
              _googleSentimentBuckets = {};
              _googleRatingDistribution = {};
            } else if (type == 'apple') {
              _appleTotalReviews = 0;
              _appleSentimentBuckets = {};
              _appleRatingDistribution = {};
            } else if (type == 'twitter') {
              _twitterTotalReviews = 0;
              _twitterSentimentBuckets = {};
            }
...
Widget build(BuildContext context) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(_googleController, 'Enter Google Play Store link'),
                    _buildAnalyzeButton(() => _analyzeSentiment('google', _googleController.text)),
                    _buildResultSection(_googleTotalReviews, _googleSentimentBuckets, _googleRatingDistribution),
                    ...
                    _buildTextField(_appleController, 'Enter Apple App Store link'),
                    _buildAnalyzeButton(() => _analyzeSentiment('apple', _appleController.text)),
                    _buildResultSection(_appleTotalReviews, _appleSentimentBuckets, _appleRatingDistribution),
  ...
  Widget _buildResultSection(int totalReviews, Map<String, int> sentimentBuckets) {
    return Column(
      ...
      children: [
        ...
        _buildRatingDistributionBar(ratingDistribution),
        Text(
          'Total Reviews Processed: $totalReviews',
          style: TextStyle(fontSize: 14, color: MyApp.navyBlue),
        ),
  ...
  Widget _buildRatingDistributionBar(Map<String, int> ratingDistribution) {
  if (ratingDistribution.isEmpty) {
    return Container();
  }

  final totalRatings = ratingDistribution.values.fold(0, (sum, item) => sum + item);
  final ratingOrder = ['5', '4', '3', '2', '1'];

  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: ratingOrder.map((rating) {
      ...
      return Padding(
        ...
        child: Row(
          children: [
            Text('$rating stars: ', style: TextStyle(fontSize: 12, color: MyApp.navyBlue)),
            Expanded(
              child: Container(
                height: 8,
                decoration: BoxDecoration(
                  color: MyApp.navyBlue,
            ...
            SizedBox(width: 5),
            Text('$count', style: TextStyle(fontSize: 12, color: MyApp.navyBlue)),
          ],
        ),
      );
    }).toList(),
